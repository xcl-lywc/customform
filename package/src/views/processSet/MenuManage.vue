...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      queryFormDetail(id){ 
        this.contentLoading = true;
        this.axios.post(`${this.common.baseProcessPath}/field/find_by_option`,{pageSize:this.elementPageData.pageSize,pageNum:this.elementPageData.pageNum,id:id}).then((response) => {
