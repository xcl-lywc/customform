          ...
          <div class="content-area">
            ...
            <el-card class="box-card" shadow="hover">
              ...
              <div class="operation-area" v-if="menuItemDetailData">
                ...
                <el-button type="primary" size="small fr marr10" icon="el-icon-magic-stick" @click="deployModel" v-if="menuItemDetailData.act_deploy_id">部署</el-button>
...
<script>
  import BpmnModel from "./components/BPMN.vue"
  export default {
    components:{
      BpmnModel
    },
    ...
    methods: {
      ...
      createModel(){ 
        ...
        console.log('创建流程xml',this.$refs.activiti_bpmn.xmlStr)
        let xmlStr = this.$refs.activiti_bpmn.xmlStr;
      ...
      saveModel(){ 
        this.dialogLoading = false;
        console.log('保存/修改流程xml',this.$refs.activiti_bpmn.xmlStr)
        let xmlStr = this.$refs.activiti_bpmn.xmlStr;
      ...
      changeStatus(type){
        ...
        console.log('切换流程时的xml',this.$refs.activiti_bpmn.xmlStr)
        let xmlStr = this.$refs.activiti_bpmn.xmlStr;
       ...
       * 子组件向父组件通讯事件
       * @author chuanlin.Xiao
       * @date   2019-10-29T10:10:28+0800
       * @param  {[type]}                 err [description]
       * @return {[type]}                     [description]
       */
      communicationEvent(data) {
